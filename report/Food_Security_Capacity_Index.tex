...
\hypersetup{
  ...
  pdfsubject={Concise revised Food Security course-project report}
}
...
\small
\textbf{Status and ownership.} Public portfolio release, reconstructed on 29 August 2026 from a collaborative course project. The repository documents a separate AI-assisted reconstruction; individual contribution claims about the original course submission are intentionally not assigned.
...
This is a stronger portfolio narrative than the original algorithm-heavy report because every method now has a distinct role and an explicit boundary. The public repository excludes the original course submission and sensitive provenance files; any future CV wording about individual contributions should remain limited to confirmed work.
...
\textbf{Authorship and contributions.} The source course work was collaborative. This release documents a separate reconstruction and does not assign unconfirmed individual roles for the original submission.
